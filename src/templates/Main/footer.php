<section class="secury">
	<div class="secury__container">
		<ul class="secury__list">
			<?php foreach ($arResult['footer-items'] as $item) : ?>
		...
		<div class="footer__container">
			<div class="footer__content">
				<div class="footer__logo footer__logo_1">
					<p class="footer__title"><?php echo htmlspecialchars($arResult['logo']) ?></p>
					<p class="footer__text"><?php echo htmlspecialchars($arResult['logo-text']) ?></p>
				</div>
				<div class="footer__items">
					<div class="footer__item item-footer">
						<h3 class="item-footer__title item-footer__title_nav"><?php echo htmlspecialchars($arResult['menu-title']) ?></h3>
						<ul class="item-footer__lists">
							<?php foreach ($arResult['menu'] as $item) : ?>
					...
					<div class="footer__item item-footer item-footer_2">
						<h3 class="item-footer__title"><?php echo htmlspecialchars($arResult['contact-title']) ?></h3>
						<ul class="item-footer__lists">
							<?php foreach ($arResult['contacts'] as $item) : ?>
								<li class="item-footer__item"><a href="#" class="item-footer__link"><?php echo htmlspecialchars($item['item']) ?></a></li>
							<?php endforeach; ?>
						</ul>
					</div>
				</div>
				<button class="footer__btn footer__btn_3"><?php echo htmlspecialchars($arResult['btnTitle']) ?></button>
			</div>
		</div>
	</footer>
</section>